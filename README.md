...
- **GPU:** Intel UHD 630 & Nvidia GTX 1050 Ti Max-Q (disabled in macOS)
- **RAM:** 16GB DDR4
- **Storage:** NVMe SSD
...
- [x] Intel UHD 630 Graphics (with hardware acceleration)
...
- [ ] Nvidia GTX 1050 Ti Max-Q (not supported in macOS)
...
1. **Prepare macOS USB Installer**: Create a macOS Sonoma installer using [macOS Recovery](https://support.apple.com/en-us/HT201372) or from a working macOS environment.
...
- [XPS 9570 Hackintosh Community](https://www.tonymacx86.com/) for testing and support
